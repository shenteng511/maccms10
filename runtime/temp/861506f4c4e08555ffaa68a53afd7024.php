<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:36:"template/datll_km/html/vod/play.html";i:1587817541;s:64:"/www/wwwroot/maccms10/template/datll_km/html/public/include.html";i:1587817535;s:61:"/www/wwwroot/maccms10/template/datll_km/html/public/head.html";i:1587817538;s:64:"/www/wwwroot/maccms10/template/datll_km/html/public/serial1.html";i:1587817540;s:61:"/www/wwwroot/maccms10/template/datll_km/html/public/foot.html";i:1587817534;}*/ ?>
<!DOCTYPE html>
...
<meta name="keywords" content="<?php echo $obj['vod_name']; ?>-<?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; ?>在线观看,<?php echo $obj['vod_name']; ?>百度网盘,<?php echo $obj['vod_name']; ?>迅雷下载,<?php echo $maccms['site_name']; ?>_国内领先的在线视频网站·免VIP在线观看无广告高清视频" />
  ...
  <div class="container">
    <div class="col-l">
      <div class="mtips"><i class="iconfont"></i>
        <div class="mtxt">正在播放：<?php echo $obj['vod_name']; ?> <?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; if($obj['type_1']['type_id'] != ''): ?> <?php echo $obj['type_1']['type_name']; else: ?> <?php echo $obj['type']['type_name']; endif; ?></div>
        <i class="iconfont" onclick="closeTips()"></i></div>
      <div class="iplays"> 
	 
		  <?php echo $player_data; ?>
		  <?php echo $player_js; ?> </div>
    </div>
...
<section class="describe">
  <div class="video-intro container">
    <div class="video-title">
      <h1><?php echo $obj['vod_name']; ?> <?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; ?></h1>
    </div>
  ...
  <div class="col-l">
    ...
    <div class="tv-bd">
      <ul class="tv-list tv-hotlist">
        ...
        <li>
          <div class="v-pic"> <img data-src="<?php echo mac_url_img($vo['vod_pic']); ?>" class="thumb" alt="<?php echo $vo['vod_name']; ?>">
            <div class="v-tips"><?php switch($vo['type_id']): case "1": if(empty($vo['vod_state']) == true): ?>
...
<?php endif; endif; break; default: endswitch; ?></div>
            <a href="<?php echo mac_url_vod_detail($vo); ?>" title="<?php echo $vo['vod_name']; ?>" class="v-playBtn"><i></i></a> </div>
          <div class="v-txt"> <span class="v-tit"><a href="<?php echo mac_url_vod_detail($vo); ?>" title="<?php echo $vo['vod_name']; ?>"><?php echo $vo['vod_name']; ?></a></span> </div>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    <div class="tv-hd v-border">
      <h2><span>影片评论</span></h2>
      <span class="s_num">共有<em><?php echo intval($__PAGING__['record_total']); ?></em>条影评</span> </div>
  ...
  <div class="col-r">
    ...
    <div class="tv-bd">
      <ul class="v-rank clearfix">
        ...
        <li><i class="i-rank_num"><?php echo $key; ?></i><em class="v-num"><?php switch($vo['type_id']): case "1": if(empty($vo['vod_state']) == true): ?>
<?php echo $vo['vod_remarks']; else: ?>
<?php echo $vo['vod_state']; endif; break; case "2": if($vo['vod_isend'] == '1'): if($vo['vod_total'] > '0'): ?>
<?php echo $vo['vod_total']; ?>集全
<?php else: ?>
...
<span style="display:none" class="mac_ulog_set" alt="设置播放页浏览记录" data-type="4" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['vod_id']; ?>" data-sid="<?php echo $param['sid']; ?>" data-nid="<?php echo $param['nid']; ?>"></span> <span style="display:none" class="mac_history_set" alt="设置History历史记录" data-name="[<?php echo $obj['type']['type_name']; ?>]<?php echo $obj['vod_name']; ?>" data-pic="<?php echo mac_url_img($obj['vod_pic']); ?>"></span> <!-- 页脚 -->
    <footer class="ifoot">
        <nav class="bnav">
		<?php $__TAG__ = '{"ids":"parent","order":"asc","by":"sort","id":"vo","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
