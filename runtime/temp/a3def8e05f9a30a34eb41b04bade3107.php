<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"template/datll_km/html/user/index.html";i:1587817547;s:62:"/www/wwwroot/maccms10/template/datll_km/html/user/include.html";i:1587817549;s:59:"/www/wwwroot/maccms10/template/datll_km/html/user/head.html";i:1587817554;}*/ ?>
		...
		<div id="tab">
			...
			<div id="listCon">
				...
				<div class="cur">
					...
					<p><span class="xiang">推广链接：</span>
						<input id="url" class="member-input" value="http://<?php echo $maccms['site_url']; ?><?php echo mac_url('user/reg'); ?>?uid=<?php echo $obj['user_id']; ?>" size="70" style="width:500px;">
				</div>
				<!-- 修改信息 -->
				<div>
