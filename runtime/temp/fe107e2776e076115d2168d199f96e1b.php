<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"template/datll_km/html/comment/ajax.html";i:1587817560;}*/ ?>
    <!--评论开始-->
        ...
        <div class="input_wrap fl clearfix">
            ...
            <div class="fl clearfix handle">
                ...
                <div class="comment_face_box face-box">
                    <?php $__FOR_START_1368798692__=1;$__FOR_END_1368798692__=16;for($i=$__FOR_START_1368798692__;$i <= $__FOR_END_1368798692__;$i+=1){ ?>
                ...
                <div class="item_con fl">
                    ...
                    <div class="gw-action">
                        <span class="click-ding-gw">
                            <a class="digg_link" data-id="<?php echo $vo['comment_id']; ?>" data-mid="6" data-type="up" href="javascript:;">
                                <i class="icon-ding"></i>
                                <em class="digg_num icon-num"><?php echo $vo['comment_up']; ?></em>
                            </a>
                            <a class="digg_link" data-id="<?php echo $vo['comment_id']; ?>" data-mid="6" data-type="down" href="javascript:;">
                                <i class="icon-dw"></i>
