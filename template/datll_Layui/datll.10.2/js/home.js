        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    var html = '<dl class="layui-nav-child"><dd><a href="'+url+'">修改信息</a></dd><dd><a href="'+url+'">用户中心</a></dd><dd><a href="javascript:;" onclick="MAC.User.Logout();" target="_self">安全退出</a></dd></dl>'
